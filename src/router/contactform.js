    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-gray-200">
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* Contact Form */}
          <div className="bg-gray-800/80 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
            {showSuccess && (
          ...
          <div className="bg-gray-800/80 backdrop-blur-md p-8 rounded-xl border border-gray-700 shadow-2xl">
            <div className="space-y-6">
              {contactItems.map((item, index) => (
                <div 
                  key={index}
                  className="flex items-start p-4 bg-gray-700/50 rounded-lg border border-gray-600 
                           transition-all duration-300 hover:translate-x-2 hover:bg-blue-500/10 
                           hover:border-blue-500/30 cursor-pointer group"
                >
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full 
                                flex items-center justify-center mr-4 text-xl group-hover:scale-110 
